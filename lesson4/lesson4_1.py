...
'''
    ...
    Вывести эту длину. Для какого максимального значения n,
...
# Time of searching 0.97 sec for array 20 000 000 items
# - CPU i3 6100  8 Gb , Windows 10
def find_the_longest_sequence(array_of_sequence):
    ...
    print("Max length is: " + str(max_item) + ", and its: "
          + str(type_of_max_item))


# Time of searching 5.35 sec for array 20 000 000 items
# - CPU i3 6100  8 Gb , Windows 10
...
def find_the_longest_sequence_alternative(array_of_sequence):
    ...
    for type_of_item in ['0', '1']:
        ...
        print('Max length of ' + type_of_item + ' is: '
              + str(len(string_of_finding)-1))
    time_finish = datetime.datetime.now()
    elapsed_time = time_finish - time_start
    print("Time of searching is: " + str(elapsed_time))
