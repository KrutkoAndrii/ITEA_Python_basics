...
def generate_matrix(matrix_rows_number, matrix_columns_number):
    matrix = [[random.randint(0, 100) for i in range(matrix_rows_number)]
              for z in range(matrix_columns_number)]
    print(matrix)
    return matrix
...
if __name__ == "__main__":
    ...
    print("Sum diagonal of matrix is: "
          + str(get_sum_diagonal(incoming_matrix, side)))
