...
class frame_window(Frame):
    ...
    def show_dict(self):
        ...
        for line in self.list_of_phonebook:
    ...
    def delete_name(self):
        ...
        for line in self.list_of_phonebook:
            ...
            if name == self.entry_name.get():
                self.list_of_phonebook.remove(line)
    ...
    def add_to_dict(self):
        ...
        if not (self.entry_name.get() == '' or self.entry_phone.get() == ''):
            ...
            self.list_of_phonebook.append(item)
            self.entry_name.delete(0, END)
        ...
        for line in self.list_of_phonebook:
            ...
            for i in phone:
                ...
                if rep == 2:
                    total += 1
                    rep = 0
                    self.text_go.insert(1.0, 'Phone ' + str(phone)
                                        + " Name " + name + '\n')
                    break
                x = i
